...
eBicicleta* nuevaBicicletaParam(char* idStr, char* nombre, char* tipo, char* tiempoStr)
{
    ...
    if(biciNueva != NULL)
    {
        bicicleta_setId_bike(biciNueva, atoi(idStr));
...
/** \brief Setea el nombre de una Bicicleta
 *
 * \param unaBici eBicicleta*
 * \param nombre char*
 * \return int
...
/** \brief Setea el tipo de bicicleta
 *
 * \param unaBici eBicicleta*
 * \param tipo char*
 * \return int
...
/** \brief Asigna a tipo , el tipo de una Bicicleta
 *
 * \param unaBici eBicicleta*
 * \param tipo char*
 * \return int
...
/** \brief Asigna a tiempo el tiempo de una Bicicleta
 *
 * \param unaBici eBicicleta*
 * \param tiempo int*
 * \return int
